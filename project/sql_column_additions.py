...
free_kick_and_penalty["on_target"] = free_kick_and_penalty.apply(
    lambda x: 1 if {"id": 1801} in x.tags else 0, axis=1
)
free_kick_and_penalty["goal"] = free_kick_and_penalty.apply(
    lambda x: 1 if {"id": 101} in x.tags else 0, axis=1
)
## find the body part of the shot
free_kick_and_penalty["body_part"] = free_kick_and_penalty.apply(
    lambda x: "left foot" if {"id": 402} in x.tags else "right foot", axis=1
)
